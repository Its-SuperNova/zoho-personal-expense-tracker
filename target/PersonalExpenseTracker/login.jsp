    ...
    <div class="auth-layout">
        <div class="auth-container">
            ...
            <div class="form-container">
                ...
                <form id="loginForm" action="login" method="post">
                    ...
                    <div class="text-center">
                        <a href="#" style="color: var(--secondary-blue); text-decoration: none; font-size: 0.875rem;">
            ...
            <div class="text-center mt-2">
                <a href="index.jsp" style="color: var(--text-secondary); text-decoration: none; font-size: 0.875rem;">
                    ← Back to Home
                </a>
            </div>
        </div>
