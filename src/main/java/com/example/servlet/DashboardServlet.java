...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            // Get recent expenses for the user (last 5)
            List<Expense> recentExpenses = expenseDAO.getExpensesByUserId(userId);
            ...
            int totalRecords = expenseDAO.getExpensesByUserId(userId).size();
